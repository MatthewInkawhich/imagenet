...
# Soft labels S2
#python -u main_adaptive2.py "configs/strider2/strider_R50_B_random.yaml" --resume-old "out/strider2/strider_R50_B_random/C0_post_S1.pth.tar" --load-selector-truth "out/strider2/strider_R50_B_random/selector_truth_train.pth.tar" --workers 8 --cycles 1 --stage1-epochs-per-cycle 0 --stage2-epochs-per-cycle 10 --lr2 0.001 --eta 1.0 --run-name "usmooth_eta1"
#python -u main_adaptive2.py "configs/strider2/strider_R50_B_random.yaml" --resume-old "out/strider2/strider_R50_B_random/C0_post_S1.pth.tar" --load-selector-truth "out/strider2/strider_R50_B_random/selector_truth_train.pth.tar" --workers 8 --cycles 1 --stage1-epochs-per-cycle 0 --stage2-epochs-per-cycle 10 --lr2 0.001 --eta 1.0 --run-name "usmooth_eta1_wrs"
python -u main_adaptive2.py "configs/strider2/strider_R50_B_random.yaml" --resume-old "out/strider2/strider_R50_B_random/C0_post_S1.pth.tar" --load-selector-truth "out/strider2/strider_R50_B_random/selector_truth_train.pth.tar" --workers 8 --cycles 1 --stage1-epochs-per-cycle 0 --stage2-epochs-per-cycle 10 --lr2 0.001 --run-name "psmooth_uniform"
